...
const createReport = async (req, res) => {
  try {
    ...
    console.error("[v0] Error al crear reporte:", error)
    res.status(500).json({
...
const getAllReports = async (req, res) => {
  try {
    ...
    console.error("[v0] Error al obtener reportes:", error)
    res.status(500).json({
...
const getReportById = async (req, res) => {
  try {
    ...
    console.error("[v0] Error al obtener reporte:", error)
    res.status(500).json({
...
const updateReportStatus = async (req, res) => {
  try {
    ...
    console.error("[v0] Error al actualizar reporte:", error)
    res.status(500).json({
